...
Phase 5 intentionally supports only LongMemEval prediction-only execution. It
creates authoritative run/checkpoint artifacts for questions, but does not
claim full judging/evaluation/report completion yet.
"""
